...
class TestBlockbuster(unittest.TestCase):
    def setUp(self):
        ...
        self.noleggio = Noleggio(self.film_list)  # Creazione di un oggetto Noleggio per i test

    def test_isAvaible(self):
        # Test disponibilità film
    ...
    def test_rentAMovie(self):
        # Test noleggio film disponibile
    ...
    def test_printRentMovies(self):
        # Test stampa film noleggiati da un cliente
        self.noleggio.rentAMovie(self.azione1, 1)
